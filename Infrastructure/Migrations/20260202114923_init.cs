        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserCivilInfo_FirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserCivilInfo_LastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
